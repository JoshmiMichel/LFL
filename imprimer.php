    ...
    <div class="bordure"> 
        <div id="div1">
            ...
            <h6 align="right">Doit à Mr, Mme :..................................</h6>
                  <table class="table table-bordered"  border="1px"  width="95%">
                  <thead>
                    <tr>
                      <!-- <th>
                 ...
                 <?php
                      try{
                        ...
                        ?>
                          ...
                          ?>
            <h6>Arret&eacute; cette pr&eacute;sence facture &agrave; la somme de: &nbsp; <?php echo  '<i class="lettre">'.$conversion->conversion($data).'</i>';?>Ariary</h6>
          <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <p align="left">
        ...
        <br><br>
        <div class="row">
          <button onclick="printContent('div1')" class="imprim w3-amber ion-ios-printer-outline"> Imprimer</button> 
          <a href="pages/form_commande.php"><button class="retour ion-ios-close-outline" > Retour au commande</button></a><br><br>
        </div>
    </div>
  </body>
