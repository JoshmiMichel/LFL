        ...
        <table id="example1" class="table table-bordered">
            ...
            ?>
                 <tr align="center">
                    ...
                    <td><span class="badge badge-pill badge-warning"> <?php echo  $produits['dateAp'] ?></span></td>
                 </tr>
            <?php
              }
                }catch(Exception $e){
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="stockForm" method="post">
          ...
          <div class="form-group">
            <input type="number" name="qtAp" class="form-control" id="qtAp" placeholder="Quantité ajouté">
          </div>
          <div class="form-group">
