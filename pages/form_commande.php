...
<div class="w3-card" id="card">
    ...
    <div class="card-body">
             ...
             try{
                ...
                while ($donnees=$reponse->fetch()){
                    ...
                    <tr align="center">
                      ...
                      <td><span class="badge badge-pill badge-warning"><?=date('d-m-Y à H:i:s',strtotime($donnees['dateAchat'])) ?></span></td>
                      <td> 
        ...
        <?php echo '<span class="select"><strong><span class="ch">'.$somme.'</span> Kg des produits sont ajoutés | </strong></span>'?>
                  <?php
                      try{
                          ...
                          echo'<div class="tot"><strong >TOTAL : <span class="ch">'.$donnees['sum(montant)'].' Ariary</span> </strong></div><br><br>';
                          }
                      }
                          catch(Exception $e)
                          {
        ...
        <div class="row pull-right">
           <button class="btn w3-dark-gray viderP"><a href="factures.php"><i class="ion-ios-printer-outline">&nbsp;&nbsp;Imprimer facture</i></a></button>
          </div><br>
        <hr>
              ...
              <div class="row">
                ...
                <div class="row">
                  <div align="right" class="col-12">
                    <button type="submit" data-toggle="modal" data-target="#viderPanier" class="btn w3-dark-gray vid"><i class="ion-android-done"></i>&nbsp;&nbsp;Vider le Panier</button>
                  </div>
                </div>
            </div><br>
        </form>
...
<br>
<!-- Modal annuler achat -->
<!-- <div class="modal fade" id="annuler" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content w3-animate-top">
      <div class="modal-header w3-amber">
         <h4 class="modal-title" id="myModalLabel">Annuler l'achat</h4>
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">x</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="notifDel"></div>
        <h4>Voulez-vous annulé cette achat !</h4>          
      </div>
      <div class="modal-footer">
        <div class="btn-group">
            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Non</button>
            <button type="button" id="annulerConfirm" class="btn btn-warning btn-sm">Oui</button>          
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="viderPanier" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header w3-amber">
         <h4 class="modal-title" id="myModalLabel">Vider le panier</h4>
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">x</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="notifDel"></div>
        <h4>Voulez-vous vidé ce Panier?</h4>          
      </div>
      <div class="modal-footer">
        <div class="btn-group">
            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Non</button>
            <button type="button" id="viderConfirm" class="btn btn-warning btn-sm">Oui</button>          
        </div>
      </div>
    </div>
  </div>
...
<div class="w3-card" id="card">
    <header class="w3-container w3-amber">
      <h4><span class="ion ion-ios-cart"></span>&nbsp;Produit en stock</h4>
     </header>
    <div class="card-body">
